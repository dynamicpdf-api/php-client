...
require_once('../../../src/EncryptDocumentComponents.php');
...
public function PdfInputFilePathAes256Security_PdfOutput()
{
    ...
    {
    file_put_contents($this->outPutPath."SecuritySamples1.pdf",$response->PdfContent);
    }
...
public function PdfInputBytesAes256Security_PdfOutput()
{
   /* $Name = "PdfInputBytesAes256Security";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples2.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputStream_Aes256Security_PdfOutput()
{
   /* $Name = "PdfInputStreamAes256Security";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples3.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputCloudRoot_Aes256Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples4.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputSubFolder_Aes256Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples5.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInput_Aes256Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples6.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInpuAes256SecurityOwnerPassword_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples7.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputAes256SecurityAllowFormFillingAndOtherProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples8.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputAes256SecurityAllowPrintAndOtherProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples9.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputFilePath_Aes256SecurityOwnerUserPassword_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples10.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInput_Aes256SecurityDocumentComponentsAll_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples11.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Aes256SecurityDocumentComponentsAllExceptMetadata_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples12.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Aes256SecurityWithoutPassword_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples13.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Aes128Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples14.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingBytes_Aes128Security_PdfOutput()
{
 /*   $Name = "PdfInputBytesPathAes128Security";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples15.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingStream_Aes128Security_PdfOutput()
{
  /*  $Name = "PdfInputStreamPathAes128Security";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples16.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingCloudRoot_Aes128Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples17.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingCloudSubFolder_Aes128Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples18.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInput_Aes128Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples19.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Aes128SecurityOwnerPassword_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples20.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Aes128SecurityAllowFormFillingAndOtherProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples21.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Aes128SecurityAllowPrintAndOtherProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples22.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Aes128SecurityUserOwnerPassword_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples23.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Aes128SecurityDocumentComponentsAll_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples24.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Aes128SecurityDocumentComponentsAllExceptMetadata_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples25.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Aes128SecurityWithoutPassword_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples26.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_RC4128Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples27.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingBytes_RC4128Security_PdfOutput()
{
  /*  $Name = "PdfInputBytesRC4128Security";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples28.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingStream_RC4128Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples29.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingCloudRoot_RC4128Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples30.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingCloudSubFolder_RC4128Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples31.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInput_RC4128Security_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples32.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_RC4128SecurityOwnerPassword_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples33.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_RC4128SecurityAllowFormFillingAndOtherProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples34.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_RC4128SecurityAllowPrintAndOtherProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples35.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_RC4128SecurityOwnerUserPassword_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples36.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_RC4128SecurityEncryptMetadata_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples37.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_RC4128SecurityEncryptExceptMetadata_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."SecuritySamples38.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
