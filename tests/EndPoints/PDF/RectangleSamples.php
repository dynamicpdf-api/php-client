...
public function PageInput_Pdfoutput()
{
    ...
    {
    file_put_contents($this->outPutPath."RectangleSamples1.pdf",$response->PdfContent);
    }
...
public function PageInputPlacement_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples2.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputXYOffset_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples3.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputCornerRadius_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples4.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputtBorderWidth_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples5.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputBorderStyle_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples6.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputBorderStyleArray_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples7.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputBorderColor_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples8.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputFillColor_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples9.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePath_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples10.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function Bytes_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples11.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function Stream_PdfOutput()
{
   /* $Name = "Stream";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples12.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRoot_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples13.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolder_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples14.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathEvenOddTemplate_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."RectangleSamples15.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
