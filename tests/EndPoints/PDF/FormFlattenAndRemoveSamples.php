...
public function PdfInputFilePath_Field_Pdfoutput()
{
    ...
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples1.pdf",$response->PdfContent);
    }
...
public function PdfInputStream_FormFlattenField_Pdfoutput()
{
   /* $Name = "StreamField";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples2.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputBytes_FormFlattenField_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples3.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputCloudRoot_FormFlattenField_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples4.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputCloudSubFolder_FormFlattenField_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples5.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputFilePath_FormFlattenFieldRemove_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples6.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputStream_FormFlattenFieldRemove_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples7.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputBytes_FormFlattenFieldRemove_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples8.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingCloudRoot_FormFlattenFieldRemove_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples9.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingCloudSubFolder_FormFlattenFieldRemove_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples10.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_FormFlattenAllFields_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples11.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingStream_FormFlattenAllFields_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples12.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingBytes_FormFlattenAllFields_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples13.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingCloudRoot_AllFields_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples14.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingCloudSubFolder_AllFields_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples15.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_RetainSignature_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples16.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingStream_RetainSignature_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples17.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingBytes_RetainSignature_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples18.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingCloudRoot_RetainSignature_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFlattenAndRemoveSamples19.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
