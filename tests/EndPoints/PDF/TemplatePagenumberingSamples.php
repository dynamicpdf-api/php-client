...
require_once('../../../src/Align.php');
require_once('../../../src/VAlign.php');
...
public function FilePathInputPNE_PdfOutput()
{
    ...
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples1.pdf",$response->PdfContent);
    }
...
public function StreamInputPNE_PdfOutput()
{
   /* $Name = "StreamInputPNE";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples2.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesInputPNE_PdfOutput()
{
   /* $Name = "BytesInputPNE";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples3.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootInputPNE_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples4.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderInputPNE_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples5.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathInputPNEWithProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples6.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathInputPNEs_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples7.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamInputPNEs_PdfOutput()
{
  /*  $Name = "StreamInputPNEs";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples8.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesInputPNEs_PdfOutput()
{
   /* $Name = "BytesInputPNEs";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples9.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootInputPNEs_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples10.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderInputPNEs_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples11.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPNEWithProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples12.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPNEsWithTokens_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples13.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePath_PNEsWithTokensAndProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples14.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePath_PNEsWithTokens_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples15.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPNEsWithTokensAndProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples16.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePath_PNEWithMultilineAndProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples17.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPNEAddedToEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples18.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function Stream_PNEAddedToEvenPages_PdfOutput()
{
   /* $Name = "Stream_PNEAddedToEvenPages";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples19.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function Bytes_PNEAddedToEvenPages_PdfOutput()
{
   /* $Name = "Bytes_PNEAddedToEvenPages";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples20.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootPNEAddedToEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples21.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderPNEAddedToEO_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples22.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPNEWithPropertiesAddedToEO_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples23.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPNEAddedToEO_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples24.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamInputPNEAddedToEO_PdfOutput()
{
   /* $Name = "StreamInputPNEAddedToEO";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples25.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesInputPNEAddedToEO_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples26.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootPNEAddedToEO_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples27.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function ColudSubFolderPNEAddedToEO_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples28.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPNEWithPropertiesEO_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples29.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputTextAndImageAndPNEWithProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplatePagenumberingSamples30.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
