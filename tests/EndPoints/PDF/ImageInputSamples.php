...
public function FilePathTiffImage_Pdfoutput()
{
    ...
    {
    file_put_contents($this->outPutPath."ImageInputSamples1.pdf",$response->PdfContent);
    }
...
public function StreamTiffImage_Pdfoutput()
{
   /* $Name = "StreamTiffImage";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples2.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesTiffImage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples3.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function ImageInputUsingCloudRoot_TiffImageAddedToInput_Pdfoutput()
{
   $Name = "CloudRootTiffImage";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples4.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathTiffImageWithProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples5.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathMulitiTiffImage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples6.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamMulitiTiffImage_Pdfoutput()
{
   /* $Name = "StreamMulitiTiffImage";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples7.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesMulitiTiffImage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples8.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathMulitiTiffImageWithProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples9.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPngImage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples10.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamPngImage_Pdfoutput()
{
   /* $Name = "StreamPngImage";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples11.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesPngImage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples12.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootPngImage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples13.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderPngImage_Pdfoutput()
{
   $Name = "CloudSubFolderPngImage";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples14.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPngImageWithProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples15.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathGifImage_Pdfouput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples16.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamGifImage_Pdfouput()
{
   /* $Name = "StreamGifImage";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples17.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesGifImage_Pdfouput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples18.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootGifImage_Pdfouput()
{
   $Name = "CloudRootGifImage";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples19.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderGifImage_Pdfouput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples20.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathGifImageWithProperties_Pdfouput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples21.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathJpegImage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples22.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamJpegImage_Pdfoutput()
{
  /*  $Name = "StreamJpegImage";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples23.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesJpegImage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples24.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootJpegImage_Pdfoutput()
{
   $Name = "CloudRootJpegImage";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples25.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderJpegImage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples26.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathJpegImageWithProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples27.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathImageWithPropertiesAddedToTemplate_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples28.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathTiffImage_AddImage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageInputSamples29.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
