...
public function PdfInputUsingFilePath_Outline_Pdfoutput()
{
    ...
    $outline = Outline::CreateOutline("OutlineA");
    ...
    {
    file_put_contents($this->outPutPath."OutlineSamples1.pdf",$response->PdfContent);
    }
...
public function PdfInputUsingFilePath_OutlineAll_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples2.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_ChildrenSimplegoto_Pdfoutput()
{
    ...
    $outlineA1 = Outline::CreateOutline("OutlineA1");
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples3.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_children_simplegotoOutOfPageIndexLeve1_Exception()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples4.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_OutlineFrominputidFromChildren_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples5.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_OutlineFrominputidFromParent_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples6.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Outline_GotoAction_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples7.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Outline_KidsBlankPageGotoAction_Pdfoutput()
{
    ...
    $outline1 = Outline::CreateOutline("OutlineA1");
    ...
    $outline2 = Outline::CreateOutline("OutlineA2");
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples8.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_OutlineSameLevel_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples9.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_OutlineSimple_Pdfoutput()
{
    ...
    $outline3 = Outline::CreateOutline("OutlineA");
    $outline3->Expanded = true;
    $outline3->Style = OutlineStyle::BoldItalic;
    $outline3->Color =  RgbColor::CreateRgbColor(1,0,0);
    $action3 = new UrlAction("https://www.dynamicpdf.com");
    $action3->Url = "https://www.dynamicpdf.com";
    $outline3->Action = $action3;
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples10.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_OutlineSimpleFromInputId_Pdfoutput()
{
    ...
    $outline3 = Outline::CreateOutline("outlineroot");
    $outline3->Expanded = true;
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples11.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_OutlineSimpleFromInputId_Children_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples12.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Outlines_simplegoto_Pdfoutput()
{
    ...
    $outline = Outline::CreateOutline("OutlineA",new GoToAction($input1,-2,PageZoom::FitPage));
    $outline->Color = RgbColor::Red();
    $outline->Style = OutlineStyle::Bold;
    $outline->Expanded = true;
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples13.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Outlines_simplegoto_mulitiple_inputs_Pdfoutput()
{
    ...
    $outline2 = Outline::CreateOutline("Outline2A");
    $outline2->Color = RgbColor::Blue();
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples14.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Outline_urlaction_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples15.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_Outlines_with_children_one_level_Pdfoutput()
{
    ...
    $outline = Outline::CreateOutline("Outline1");
    $outline->Color = RgbColor::Red();
    $outline->Style = OutlineStyle::Bold;
    $outline->Expanded = true;

    $outline1A = Outline::CreateOutline("Outline1A");
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples16.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_ChildrenFrominputIds_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."OutlineSamples17.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
