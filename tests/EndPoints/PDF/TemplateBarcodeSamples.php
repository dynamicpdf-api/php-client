...
require_once('../../../src/Elements/AztecSymbolSize.php');


require_once('../../../src/PageInput.php');
require_once('../../../src/Elements/ValueType.php');
...
require_once('../../../src/Elements/Compaction.php');
require_once('../../../src/Elements/ErrorCorrection.php');
require_once('../../../src/Elements/QrCodeElement.php');
require_once('../../../src/Elements/QrCodeFnc1.php');
...
require_once('../../../src/Elements/MsiBarcodeCheckDigitMode.php');
...
public function FilePathInputAztecBarcode_Pdfoutput()
{
    ...
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples1.pdf",$response->PdfContent);
    }
...
public function FilePathInputAztecBarcodeSize_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples2.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathAztecBarcodeElementError_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples3.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathAztecBarcodeElementTilde_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples4.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathAztecBarcodeElementReader_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples5.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePath_AztecBarcodeElementXDimension_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples6.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathAztecBarcodeElementColor_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples7.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathAztecBarcodeElementProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples8.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesAztecBarcodeElementProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples9.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamAztecBarcodeElementProperties_Pdfoutput()
{
   /* $Name = "StreamAztecBarcodeElementProperties_Pdfoutput";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples10.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootAztecBarcodeElementProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples11.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputAztecBarcodeElementProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples12.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputAztecBarcodeElementPropertiesAddedToPage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples13.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputAztecBarcodeAddedToPageAndPdf_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples14.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathAztecBarcodeElementByteArray_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples15.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathAztecBarcodeElementPageByteArray_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples16.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathAztecBarcodeElementPageXY_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples17.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathDataMatrixBarcodeElement_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples18.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathDataMatrixBarcodeElementXDimension_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples19.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathDataMatrixBarcodeElementColor_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples20.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathDataMatrixBarcodeElementPlacement_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples21.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathDataMatrixBarcodeElementTilde_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples22.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathDataMatrixBarcodeElementSymbolSize_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples23.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathDataMatrixBarcodeElementEncodingType_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples24.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathDataMatrixBarcodeElementFucntionChar_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples25.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathDataMatrixBarcodeElementEnums_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples26.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathDataMatrixBarcodeElementProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples27.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesDataMatrixBarcodeElementProperties_Pdfoutput()
{
   /* $Name = "BytesDataMatrixBarcodeElementProperties";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples28.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamDataMatrixBarcodeElementProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples29.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootDataMatrixBarcodeElementProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples30.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPdf417BarcodeElement_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples31.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPdf417BarcodeElementTilde_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples32.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPdf417BarcodeElementCompaction_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples33.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPdf417BarcodeElementErrorCorrection_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples34.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPdf417BarcodeElementCompactPdf417_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples35.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPdf417BarcodeElementYDimension_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples36.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPdf417BarcodeElementProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples37.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamPdf417BarcodeElementProperties_Pdfoutput()
{
   /* $Name = "StreamPdf417BarcodeElementProperties";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples38.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesPdf417BarcodeElementProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples39.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootPdf417BarcodeElementProperties_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples40.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathPdf417BarcodeElementByteArray_Pdfoutput()
{
  /*  $Name = "FilePathPdf417BarcodeElementByteArray";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples41.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathQrcodeBarcodeElement_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples42.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathQrcodeBarcodeElementVersion_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples43.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathQrcodeBarcodeElementFnc1_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples44.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathQrcodeBarcodeElementProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples45.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesQrcodeBarcodeElementProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples46.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamQrcodeBarcodeElementProperties_PdfOutput()
{
   /* $Name = "StreamQrcodeBarcodeElementProperties";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples47.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootQrcodeBarcodeElementProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples48.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathQrcodeBarcodeElementByteArray_PdfOutput()
{
  /*  $Name = "FilePathQrcodeBarcodeElementByteArray";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples49.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode128Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples50.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesCode128Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples51.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamCode128Barcode_PdfOutput()
{
  /*  $Name = "StreamCode128Barcode";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples52.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootCode128Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples53.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderCode128Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples54.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode128BarcodeWithOptionalParameter_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples55.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode128BarcodeWithHeightXY_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples56.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode128BarcodeColorXdimension_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples57.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode128BarcodeTextProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples58.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode128BarcodePlacement_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples59.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode128BarcodeProcessTilde_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples60.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode128BarcodeUccEan128_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples61.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode128BarcodeEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples62.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode128BarcodeOddPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples63.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputCode128Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples64.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputWithTemplateCode128Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples65.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode39Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples66.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesCode39Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples67.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamCode39Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples68.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootCode39Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples69.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderCode39Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples70.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode39BarcodeOptionalParameter_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples71.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode39BarcodeHeightXY_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples72.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode39BarcodeColorXdimension_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples73.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode39BarcodeTextProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples74.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode39BarcodeEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples75.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode39BarcodeOddPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples76.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputCode39Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples77.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputTemplateCode39Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples78.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode39BarcodeExtended_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples79.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples80.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesCode25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples81.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamCode25Barcode_PdfOutput()
{
  /*  $Name = "StreamCode25Barcode";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples82.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootCode25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples83.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderCode25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples84.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode25BarcodeOptionalParameter_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples85.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode25BarcodeHeightXY_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples86.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode25BarcodeColorXdimension_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples87.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode25BarcodeTextProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples88.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode25BarcodeEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples89.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode25BarcodeOddPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples90.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputCode25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples91.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputTemplateCode25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples92.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode93Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples93.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesCode93Barcode_PdfOutput()
{
   /* $Name = "BytesCode93Barcode";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples94.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamCode93Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples95.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootCode93Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples96.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderCode93Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples97.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode93BarcodeOptionalParameter_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples98.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode93BarcodeHeightXY_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples99.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode93BarcodeColorXdimension_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples100.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode93BarcodeTextProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples101.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode93BarcodeEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples102.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode93BarcodeOddPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples103.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputCode93Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples104.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputTemplateCode93Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples105.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode93BarcodeExtended_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples106.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode11Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples107.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesCode11Barcode_PdfOutput()
{
  /*  $Name = "BytesCode11Barcode";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples108.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamCode11Barcode_PdfOutput()
{
  /*  $Name = "StreamCode11Barcode";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples109.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootCode11Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples110.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderCode11Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples111.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode11BarcodeOptionalParameter_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples112.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode11BarcodeHeightXY_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples113.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode11BarcodeColorXdimension_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples114.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode11BarcodeTextProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples115.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode11BarcodeEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples116.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathCode11BarcodeOddPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples117.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputCode11Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples118.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputTemplateCode11Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples119.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathGs1DataBarBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples120.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesGs1DataBarBarcode_PdfOutput()
{
   /* $Name = "BytesGs1DataBarBarcode";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples121.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamGs1DataBarBarcode_PdfOutput()
{
   /* $Name = "StreamGs1DataBarBarcode";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples122.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootGs1DataBarBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples123.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderGs1DataBarBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples124.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathGs1DataBarBarcodeOptionalParameter_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples125.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathGs1DataBarBarcodeHeightXY_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples126.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathGs1DataBarBarcodeColorXdimension_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples127.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathGs1DataBarBarcodeTextProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples128.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathGs1DataBarBarcodeEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples129.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathGs1DataBarBarcodeOddPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples130.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputGs1DataBarBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples131.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputTamplateGs1DataBarBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples132.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathStackedGS1DataBarBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples133.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesStackedGS1DataBarBarcode_PdfOutput()
{
  /*  $Name = "BytesStackedGS1DataBarBarcode";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples134.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamStackedGS1DataBarBarcode_PdfOutput()
{
   /* $Name = "StreamStackedGS1DataBarBarcode";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples135.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootStackedGS1DataBarBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples136.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderStackedGS1DataBarBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples137.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathStackedGS1DataBarBarcodeOptionalParameter_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples138.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathStackedGS1DataBarBarcodeRowheightXY_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples139.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathStackedGS1DataBarBarcodeColorXdimension_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples140.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathStackedGS1DataBarBarcodeTextProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples141.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathStackedGS1DataBarBarcodeEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples142.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathStackedGS1DataBarBarcodeOddPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples143.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputStackedGS1DataBarBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples144.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputTemplateStackedGS1DataBarBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples145.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathIata25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples146.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesIata25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples147.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamIata25Barcode_PdfOutput()
{
  /*  $Name = "StreamIata25Barcode";
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples148.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputCloudRoot_Iata25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples149.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderIata25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples150.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathIata25BarcodeOptionalParameter_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples151.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathIata25BarcodeHeightXY_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples152.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathIata25BarcodeColorXdimension_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples153.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathIata25BarcodeTextProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples154.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathIata25BarcodeIncludeCheckDigit_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples155.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathIata25BarcodeEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples156.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathIata25BarcodeOddPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples157.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputIata25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples158.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputWithTemplateIata25Barcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples159.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathMsiBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples160.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function BytesMsiBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples161.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function StreamMsiBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples162.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudRootMsiBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples163.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function CloudSubFolderMsiBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples164.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathMsiBarcodeOptionalParameter_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples165.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathMsiBarcodeHeightXYAppendcheckdigit_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples166.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathMsiBarcodeColorXdimension_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples167.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathMsiBarcodeTextProperties_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples168.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathMsiBarcodeAppendCheckDigit_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples169.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathMsiBarcodeEvenPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples170.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function FilePathMsiBarcodeOddPages_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples171.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInputMsiBarcode_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."TemplateBarcodeSamples172.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
