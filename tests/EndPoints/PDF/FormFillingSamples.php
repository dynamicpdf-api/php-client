...
public function PdfInputFilePath_PdfOutput()
{
    ...
    {
    file_put_contents($this->outPutPath."FormFillingSamples1.pdf",$response->PdfContent);
    }
...
public function PdfInputStream_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples2.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputBytes_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples3.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputCloudRoot_FormFill_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples4.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputCloudSubFolder_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples5.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputFilePath_TextBox_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples6.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputFilePath_ComboBox_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples7.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputFilePath_ListBox_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples8.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputFilePath_RadioButton_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples9.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputFilePath_CheckBox_PdfOutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples10.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputFilePath_XfaFormFill_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples11.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputStream_Xfa_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples12.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputBytes_Xfa_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples13.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputCloudRoot_Xfa_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."FormFillingSamples14.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
