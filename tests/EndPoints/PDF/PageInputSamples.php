...
public function PageInput_TextElement_Pdfoutput()
{
    ...
    {
    file_put_contents($this->outPutPath."PageInputSamples1.pdf",$response->PdfContent);
    }
...
public function PageInput_TextElementAddedToPageAndTemplate_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."PageInputSamples2.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInput_AddPage_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."PageInputSamples3.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInput_AddPageTemplate_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."PageInputSamples4.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PageInput_AddPageParameters_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."PageInputSamples5.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
