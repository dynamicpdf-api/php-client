...
public function PdfInputUsingFilePath_WithTemplate_Pdfoutput()
{
    ...
    {
    file_put_contents($this->outPutPath."ImageElementSamples1.pdf",$response->PdfContent);
    }
...
public function PdfInputUsingFilePath_Templatescale_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageElementSamples2.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_TemplateWidth_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageElementSamples3.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingFilePath_TemplateWithXY_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageElementSamples4.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfPageInput_Template_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageElementSamples5.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfPageInput_Page_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageElementSamples6.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingStream_Template_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageElementSamples7.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingBytes_Template_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageElementSamples8.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
...
public function PdfInputUsingCloudRoot_Template_Pdfoutput()
{
    ...
    if($response->IsSuccessful)
    {
    file_put_contents($this->outPutPath."ImageElementSamples9.pdf",$response->PdfContent);
    }
    if(isset($pdf->jsonData))
